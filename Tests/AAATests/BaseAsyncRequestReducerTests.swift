...
//    typealias Reducer = BaseAsyncCallReducer<AuthorizationUrl.Parameter,Bool>
//    typealias State = Reducer.State
//    
//    func fetchWrapper(input: Sendable) async throws -> Sendable{
//        let response = try await AuthorizationUrl.authFlow(parameter: input as! AuthorizationUrl.Parameter)
//        print(response)
...
//            $0.asyncCallClient = AsyncCallClient(fetch: fetchWrapper)
//        }
